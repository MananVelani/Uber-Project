 ...
 const submitHandler = (e)=>{
  ...
  return (
    <div className='p-2'>
        ...
        <div className='flex items-center mb-4 border-2 border-[#F7D33D] rounded-lg py-2 px-3  mt-4'>
          ...
          <div className='mt-1  p-6'>
            ...
            className='bg-red-600 w-full font-semibold text-white px-3 py-3 rounded-lg mt-1 text-base' >Cancel</button>
