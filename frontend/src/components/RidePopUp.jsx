...
const RidePopUp = (props) => {
  return (
    <div className='p-2'>
        ...
        <div className='flex items-center mb-4 bg-[#F7D33D] rounded-lg py-2 px-3  mt-4'>
          ...
          <div className='flex justify-around mt-6'>
            ...
            className='bg-gray-300 w-2/5 font-semibold text-gray-700 px-3 py-3 rounded-lg text-base' >Ignore</button>
           ...
           <button
            ...
            className='bg-green-600 w-2/5 font-semibold text-white px-3 py-3 rounded-lg text-base' >Accept</button>
